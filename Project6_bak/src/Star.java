...
public class Star
{
	...
	public void update(long delta, double timeScale)
	{
		if(currentLife <= 0)
			hasDied = true;
		else
		{
            ...
            if(mode.equals("CHASE"))
			{
				...
				x += speed_x * delta * timeScale;
	            y += speed_y * delta * timeScale;
            ...
            if(mode.equals("RANDOM"))
			{
				if(!hasSpeed)
				{
	    	        ...
	    	        speed_x = delta_x/(r.nextInt(600)+600);
	    	        speed_y = delta_y/(r.nextInt(600)+600);
	    	        hasSpeed = true;
				}
